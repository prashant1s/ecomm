...
//               // 👇 FIX: Changed bg-white to bg-gray-100 and border-gray-100 to border-gray-200
//               className="bg-slate-200 rounded-xl border hover:shadow-xl hover:border-gray-300 transition-all duration-300 flex flex-col h-full relative group p-4"
//             >
//               <Link
